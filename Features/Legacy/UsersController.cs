...
namespace QLStudy.Service.Api.Features.Legacy
{
    ...
    public class UsersControllerLogic : BaseApiController
    {
        private readonly PasswordHasher<User> _passwordHasher;

        public UsersControllerLogic(QLStudyDbContext context) : base(context)
        {
        ...
        public async Task<IActionResult> DeleteUser(int id)
        {
            ...
            {
                return BadRequest(new { message = "Báº¡n khÃ´ng thá»ƒ tá»± xÃ³a tÃ i khoáº£n cá»§a chÃ­nh mÃ¬nh." });
            }
