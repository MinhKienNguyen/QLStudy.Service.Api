...
namespace QLStudy.Service.Api.Features.Legacy
{
    ...
    public class TuitionControllerLogic : BaseApiController
    {
        public TuitionControllerLogic(QLStudyDbContext context) : base(context)
        {
        }
        ...
        public async Task<IActionResult> SaveAdjustment([FromBody] TuitionAdjustmentDto dto)
        {
            ...
            if (user.Role == "Teacher")
            {
                ...
                {
                    return Forbid("BÃ¡ÂºÂ¡n khÃƒÂ´ng cÃƒÂ³ quyÃ¡Â»Ân cÃ¡ÂºÂ­p nhÃ¡ÂºÂ­t hÃ¡Â»Âc phÃƒÂ­ cÃ¡Â»Â§a lÃ¡Â»â€ºp hÃ¡Â»Âc nÃƒÂ y.");
                }
            }
